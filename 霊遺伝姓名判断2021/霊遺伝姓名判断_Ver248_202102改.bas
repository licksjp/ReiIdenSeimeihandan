...
10950 color rgb(255,0,255):PRINT"Ver:2.48.20210214(改)"+chr$(13)
...
11000 'ここを書き換える
11010 talk "このプログラムは、姓名判断バージョン2.48です"
...
38390 endif
38400 '中順序型(上下系)
38410 if ((abs(Aijyou_wasu - Senzo_wasu - 1) = 0) And abs(Koudou_wasu - Seikaku_wasu - 1) > 0 and abs(Aijyou_wasu - Koudou_wasu - 1) = 1 ) then
38420 if Senzo_wasu > Seikaku_wasu then
38430 Sa_count = (Seikaku_wasu + 9)-Senzo_wasu - 1
38440 else
38450 Sa_count = Senzo_wasu - Seikaku_wasu - 1
38460 endif
...
38790 if (abs(Koudou_wasu - Senzo_wasu) = 2 And abs(Aijyou_wasu - Seikaku_wasu) = 2 And ((abs(Senzo_wasu)=2 And Aijyou_wasu = 9) or abs(Senzo_wasu-Aijyou_wasu)=2)) then
...
39020 if ((Koudou_wasu - Senzo_wasu) = 2 And abs(Aijyou_wasu - Seikaku_wasu) = 2 ) then
